	...
	_react2['default'].render(_react2['default'].createElement(
		...
		_react2['default'].createElement(
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(_reactRouter.IndexRoute, { component: _componentsRoutesPostsJsx2['default'] }),
				_react2['default'].createElement(_reactRouter.Route, { path: ':id', component: _componentsRoutesPostJsx2['default'] })
			),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavBarJsx = __webpack_require__(208);

	var _NavBarJsx2 = _interopRequireDefault(_NavBarJsx);

	var _CoverPhotoJsx = __webpack_require__(209);
	...
	var Post = (function (_React$Component) {
		...
		_createClass(Post, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					_pagePageJsx2['default'],
					{ title: title, coverPhoto: '../../../src/images/posts/' + this.props.params.id + '/preview', blankNav: true },
					_react2['default'].createElement(
						_pageCoverJsx2['default'],
						null,
						_react2['default'].createElement(
